...
class Configurable(object):
  ...
  @property
  def nbest(self):
    return self._config.getint('Forest', 'nbest')

  argparser.add_argument('--nbest')

  @property
  def train_forest_file(self):
    return self._config.get('Forest', 'train_forest_file')

  argparser.add_argument('--train_forest_file')

  @property
  def valid_forest_file(self):
    return self._config.get('Forest', 'valid_forest_file')

  argparser.add_argument('--valid_forest_file')

  @property
  def test_forest_file(self):
    return self._config.get('Forest', 'test_forest_file')

  argparser.add_argument('--test_forest_file')

  @property
  def nbest_only_keep(self):
    return self._config.getint('Forest', 'nbest_only_keep')

  argparser.add_argument('--nbest_only_keep')

  @property
  def num_syntax_match_layer(self):
    return self._config.getint('Forest', 'num_syntax_match_layer')

  argparser.add_argument('--num_syntax_match_layer')

  @property
  def cube_only_keep(self):
    return self._config.getfloat('Forest', 'cube_only_keep')
  argparser.add_argument('--cube_only_keep')

  @property
  def use_forest(self):
    return self._config.getboolean('Forest', 'use_forest')

  argparser.add_argument('--use_forest')

  @property
  def use_feature_residual(self):
    return self._config.getboolean('Forest', 'use_feature_residual')

  argparser.add_argument('--use_feature_residual')

  @property
  def forest_type(self):
    return self._config.getint('Forest', 'forest_type')
  argparser.add_argument('--forest_type')
